...
//    }
     ...
     */
    public static String getYyyyMMddHHmmssSSS(Date d) {
        return format(DF_DATE_TIME_MILLISECOND, d);
    }
...
//    }
    ...
    private static final DateFormat DF_DATE_TIME_MILLISECOND = new SimpleDateFormat("yyyyMMddHHmmssSSS");
